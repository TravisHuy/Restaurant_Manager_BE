    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        .requestMatchers("/api/auth/all/users").hasAnyAuthority("ROLE_ADMIN")
                        ...
                        .requestMatchers("/api/notifications/admin/**").hasAnyAuthority("ROLE_ADMIN")
                        .requestMatchers("/api/notifications/manager/**").hasAuthority("ROLE_MANAGER")
                        .requestMatchers("/api/notifications/employee/**").hasAuthority("ROLE_EMPLOYEE")
                        .requestMatchers("/api/notifications/entity/**").authenticated()
                        .requestMatchers("/api/notifications/unread/**").authenticated()
                        .requestMatchers("/api/notifications/{notificationId}/read").authenticated()
                        .requestMatchers("/api/notifications/read-all/**").authenticated()
